        ...
        <div class="x_panel">
            ...
            <div class="x_content">
              ...
              @endif
                <!-- Smart Wizard -->
                <p>cheme.</p>
                <form class="form-horizontal form-label-left" action="/user/ThemMonan" method="post">
                    {{ csrf_field() }}
                    <div>
                        ...
                        <div class="tab-content" style="margin-top: 25px">
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-10 col-xs-12 col-lg-offset-2 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="tenMonan" name="tenMonan" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="tenMonan">Giới thiệu</label>
                                        <textarea name="gioithieu" class="form-control" rows="3"></textarea>

                                    </div>

                                    <div class="form-group">
                                        <label for="huongdan">Hướng dẫn chi tiết</label>
                                        <textarea class="ckeditor" id="huongdan" name="huongdan" rows="10"></textarea>
                            ...
                            <div role="tabpanel" class="tab-pane form-horizontal form-label-left" id="step-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control" name="hinhMinhhoa" id="hinhMinhhoa">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control" name="nguon" id="nguon">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" class="form-control" name="thoigian" id="thoigian">
                                    </div>
                                </div>
