        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('/') }}" class="site_title"><i class="fa fa-paw"></i> <span>CookingA-Z!</span></a>
            </div>
...
<<<<<<< HEAD
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('danhmuc-index')}}">Quản lý danh mục</a></li>
                      <li><a href="{{route('monan.index')}}">Quản lý món ăn</a></li>
                      <li><a href="{{route('nlcc-index')}}">Quản lý nguyên liệu và công cụ</a></li>
=======
...
>>>>>>> master
    ...
    <script src="{{ URL::asset('Admin/jszip/dist/jszip.min.js') }}"></script>
    <script src="{{ URL::asset('Admin/pdfmake/build/pdfmake.min.js') }}"></script>
