...
<title>Cooking A-Z @yield('title')</title>
  ...
  <div class="container-fluid footer">
    <div class="row">
      <div class="col-xs-6 col-sm-2">
        <div class="row">
          <ul>
            <li><a href="http://localhost:1337/laravel/thucan" >Trang chủ</a></li>
            <li><a href="http://localhost:1337/laravel/outside" >Món chính</a></li>
